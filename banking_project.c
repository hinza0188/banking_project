...
int bank_flag, teller_waiting_time, teller_working_time, queue_max_time, max_break_duration1, max_break_duration2;
int max_break_duration3, min_break_duration1, min_break_duration2, min_break_duration3, break_duration_time1;
int break_duration_time2, break_duration_time3;
...
void* teller1( void* arg ) {
	...
	int min = 30*SEC;
	int max = 8 *MIN;
	int hr, mn, sec, wait_time, teller_wait, nsec, break_time, break_duration;
